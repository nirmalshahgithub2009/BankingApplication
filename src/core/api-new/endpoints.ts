...
// ==================== Base Configuration ====================
const DEFAULT_BASE_URL = __DEV__ ? 'https://dev-api.bankapp.local' : 'https://api.bankapp.com';

const env = (globalThis as any).process?.env as Record<string, string | undefined> | undefined;

const ENV_BASE_URL = env?.API_BASE_URL || env?.REACT_APP_API_BASE_URL || DEFAULT_BASE_URL;

const ENV_TIMEOUT = Number(env?.API_TIMEOUT || env?.REACT_APP_API_TIMEOUT || '30000');
const ENV_MAX_RETRIES = Number(env?.MAX_RETRIES || env?.REACT_APP_MAX_RETRIES || '3');
